---
title: Research
description: Research areas, publications, and grants of the Shao Lab.
keywords:
  - Research
  - Publications
  - Grants
...
We build process-based ecosystem models that treat microorganisms as active participants in biogeochemical cycling, and test them against field and laboratory data across peatlands, forests, and croplands.

## Research Areas

- Plant–microbe interactions and mycorrhizal ecology
- Process-based ecosystem and biogeochemical modeling
- Peatland carbon and nutrient cycling
- Enhanced rock weathering and soil-based carbon dioxide removal
- Microbial trait representation in Earth system models
- Knowledge-guided machine learning and ecosystem digital twins
...
**Shao, S.**, Zhang, J., Zhou, L., & Xue, W. (2017). Aerosol effects on global surface solar radiation based on Fu-Liou modeling and satellite observations. *Resources Science*, 39(3), 513–521. [https://doi.org/10.18402/resci.2017.03.13](https://doi.org/10.18402/resci.2017.03.13)

Zhang, J., Lyu, Z., **Shao, S.**, Li, F., Yang, S., Song, W., Li, W., Li, S., & Li, C. (2016). Effects of aluminum toxicity induced by acid deposition on pine forest ecosystem in Longli of Guizhou Province, southwestern China. *Chinese Geographical Science*, 26(4), 495–507. [https://doi.org/10.1007/s11769-015-0763-0](https://doi.org/10.1007/s11769-015-0763-0)
...
**Shao, S.**, Sulman, B., & Hicks Pries, C. Inclusion of mycorrhizal functional diversity improved ecosystem model predictions on soil nitrogen cycles.

Rocci, K. S., **Shao, S.**, Sulman, B. N., Aguilar-Trigueros, C. A., DeLancey, L. C., Edwards, J., Frey, S. D., Kivlin, S. N., Limbu, S. P., Morrison, E. W., Poelen, J., Shulman, H., Zanne, A., Zhang, H., & Camenzind, T. Aligning measured and modeled fungal traits for improved understanding of fungal controls on soil carbon cycling.
